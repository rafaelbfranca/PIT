...
public class H_meus_palpites_serie_B extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    private AdView adView;
    private final String selectedSerie = "SerieB";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.h_meus_palpites_serie_b);
        loadAds();
    ...
    private void loadAds(){
        adView = findViewById(R.id.adsPalpitesSerieB);
...
//-----Fim Bloco Exibição de Anúncios-----
    ...
    private void atualizaCampos(){
        ...
        String saldo_time_campeao = prefs.getString("palpiteSaldoTimeCampeaoSerieB","--");
        ...
        String saldo_time_lanterna = prefs.getString("palpiteSaldoTimeLanternaSerieB","--");
    ...
    public void buttonPalpitarJogos(@SuppressWarnings("unused") View view){
        ...
        Intent palpitarJogos = new Intent(this, M_palpitar_jogos_serie_B.class);
