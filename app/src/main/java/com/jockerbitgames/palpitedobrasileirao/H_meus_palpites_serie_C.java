...
public class H_meus_palpites_serie_C extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    private AdView adView;
    private final String selectedSerie = "SerieC";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.h_meus_palpites_serie_c);
        loadAds();
    ...
    private void loadAds(){
        adView = findViewById(R.id.adsPalpitesSerieC);
...
//-----Fim Bloco Exibição de Anúncios-----
    ...
    private void implementaSpinners(){
        ...
        //Implementa o dropdown acesso01.
    ...
    private void atualizaCampos(){
        ...
        String saldo_time_lanterna = prefs.getString("palpiteSaldoTimeLanternaSerieC","--");
    ...
    public void buttonPalpitarJogos(@SuppressWarnings("unused") View view){
        ...
        Intent palpitarJogos = new Intent(this, M_palpitar_jogos_serie_C.class);
