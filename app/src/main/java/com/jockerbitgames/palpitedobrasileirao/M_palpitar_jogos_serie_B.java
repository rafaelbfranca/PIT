...
public class M_palpitar_jogos_serie_B extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.m_palpitar_jogos_serie_b);
        loadAds();
    ...
    private void loadAds(){
        adView = findViewById(R.id.adsPalpitarJogosSerieB);
...
//-----Fim Bloco Exibição de Anúncios-----
    ...
    public void onBackPressed(){
        ...
        Intent meusPalpites = new Intent(this,H_meus_palpites_serie_B.class);
