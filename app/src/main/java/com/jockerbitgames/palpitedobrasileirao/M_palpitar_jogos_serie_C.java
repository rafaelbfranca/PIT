...
public class M_palpitar_jogos_serie_C extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.m_palpitar_jogos_serie_c);
        loadAds();
    ...
    private void loadAds(){
        adView = findViewById(R.id.adsPalpitarJogosSerieC);
...
//-----Fim Bloco Exibição de Anúncios-----
    ...
    public void onBackPressed(){
        ...
        Intent meusPalpites = new Intent(this,H_meus_palpites_serie_C.class);
